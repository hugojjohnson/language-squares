...
export default function Main() {
    ...
    const { deleteWord, starWord, generateAudio, changeBucket } = useWordsManager();
    ...
    function WordRow({ word, index }: { word: Word, index: number }) {
        return <tr key={index} className="border-b-2 border-b-gray-300 py-0 group">
            ...
            {/* <img src={binImg} alt="delete icon" onClick={() => deleteWord.mutate(word.id)} className="w-5 mx-auto group-hover:visible invisible hover:cursor-pointer" /> */}
            {/* <td>...</td> */}
        </tr>
    }
